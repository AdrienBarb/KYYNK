          ...
          <ul className="flex w-full border border-primary rounded-md">
            <li
              ...
              className={`${
                ...
                filters.mediaTypes === 'bundle' ? 'bg-primary' : 'bg-secondary'
            ...
            <li
              ...
              className={`${
                ...
                filters.mediaTypes === 'video' ? 'bg-primary' : 'bg-secondary'
              } font-rubik font-light w-full text-center cursor-pointer hover:bg-primary-light p-2 rounded-md`}
            >
              {`${t('Video')}`}
            </li>
            <li
              ...
              className={`${
                ...
                filters.mediaTypes === 'photo' ? 'bg-primary' : 'bg-secondary'
              } font-rubik font-light w-full text-center cursor-pointer hover:bg-primary-light p-2 rounded-md`}
            >
              {`${t('Photo')}`}
            </li>
        ...
        <div className="mb-12">
          ...
          <ul className="flex w-full border border-primary rounded-md">
            <li
              ...
              className={`${
                filters.isFree === false ? 'text-secondary' : 'text-primary'
              } ${
                filters.isFree === false ? 'bg-primary' : 'bg-secondary'
              } font-rubik font-light w-full text-center cursor-pointer hover:bg-primary-light p-2 rounded-md`}
            >
              {`${t('Paid')}`}
            </li>
            <li
              ...
              className={`${
                filters.isFree === true ? 'text-secondary' : 'text-primary'
              } ${
                filters.isFree === true ? 'bg-primary' : 'bg-secondary'
              } font-rubik font-light w-full text-center cursor-pointer hover:bg-primary-light p-2 rounded-md`}
            >
              {`${t('Free')}`}
            </li>
